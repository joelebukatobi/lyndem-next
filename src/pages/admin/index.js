...
export default function Dashboard({ token, games, questions, reviews }) {
  ...
  return (
    <Layout className={viewGame || createGame ? 'blur-sm' : 'blur-none'}>
      ...
      <ToastContainer />
      <div className="w-full flex justify-between mt-[2.4rem]">
        <div className="w-[30%] bg-white h-[12rem] p-[2.4rem] flex items-center space-x-[1.6rem] rounded-[1rem]">
          ...
          <div className="space-y-[.4rem]">
            <h6 className="leading-none">Total Games</h6>
            <h3 className="font-bold leading-none">{games.count}</h3>
            <h6 className="leading-none text-green-600">
              <Link href="/admin/games">View Game -&gt;</Link>
            </h6>
          </div>
        </div>
        <div className="w-[30%] bg-white h-[12rem] p-[2.4rem] flex items-center space-x-[1.6rem] rounded-[1rem]">
          <div className="h-[7.2rem] w-[7.2rem] bg-black rounded-[100%]"></div>
          <div className="space-y-[.4rem]">
            <h6 className="leading-none">Total Questions</h6>
            <h3 className="font-bold leading-none">{questions.count}</h3>
            <h6 className="leading-none text-green-600">
              <Link href="/admin/games">View Questions -&gt;</Link>
            </h6>
          </div>
        </div>
        <div className="w-[30%] bg-white h-[12rem] p-[2.4rem] flex items-center space-x-[1.6rem] rounded-[1rem]">
          <div className="h-[7.2rem] w-[7.2rem] bg-black rounded-[100%]"></div>
          <div className="space-y-[.4rem]">
            <h6 className="leading-none">Total Reviews</h6>
            <h3 className="font-bold leading-none">{reviews.count}</h3>
            <h6 className="leading-none text-green-600">
              <Link href="/admin/games">View Reviews -&gt;</Link>
            </h6>
          </div>
        </div>
      </div>
...
export async function getServerSideProps({ req }) {
  ...
  const res = await Promise.all([
    ...
    fetch(`${API_URL}/backend/api/v1/reviews`),
  ]);
