    ...
    <Layout title={'Games'} className={''}>
      <div className="h-[92vh] flex flex-col w-full justify-center px-[16rem] ">
        ...
        <div className="flex flex-col items-center justify-center mt-[-16rem] mb-[2.4rem]">
          ...
          <p className="font-Nunito">Enter the question below to get the possible answers</p>
          <p className="font-Nunito text-red-600">{error}</p>
        </div>
        <form onSubmit={handleSubmit} className="w-full h-[8rem] flex items-center justify-center relative mb-[1.6rem]">
          <Input
            type={'text'}
            value={term}
      ...
      {modal && (
        ...
        >
          <div className="px-[6.4rem] pt-[3.2rem] pb-[7.2rem] bg-white rounded-[1rem] w-[80%] md:w-[40%] xl:w-[30%] flex flex-col">
            <p
            ...
            <div className="flex justify-between mb-[5.6rem] gap-x-[2.4rem]">
              <div className="flex gap-x-[1.6rem] items-center w-2/4">
                ...
                <div className="relative flex items-center justify-center w-[90%]">
                  ...
                  <h3 className="absolute text-white font-Domine font-bold">{modal.answer[0].a}</h3>
                </div>
              </div>
              <div className="flex gap-x-[1.6rem] items-center w-2/4">
            ...
            <div className="flex justify-between mb-[2.4rem] gap-x-[2.4rem]">
              ...
              <div className="flex gap-x-[1.6rem] items-center w-2/4">
                ...
                <div className="relative flex items-center justify-center w-[90%]">
                  ...
                  <h3 className="absolute text-white font-Domine font-bold">{modal.answer[0].d}</h3>
                </div>
              </div>
            </div>
          </div>
